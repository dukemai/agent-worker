...
- `TripDetail.dc.html` — Trip detail workspace, Logistics tab (header, readiness-warning banner, tab bar, trip-basics/participants/preferences/transport/planning-context panels).
